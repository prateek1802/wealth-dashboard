...
const MOBILE_TABS = [
  ...
  { href: ROUTES.portfolio, label: "Stocks", icon: Wallet },
  { href: ROUTES.transactions, label: "Activity", icon: Receipt },
  { href: ROUTES.analytics, label: "Analytics", icon: LineChart },
];

/** Everything that doesn't fit in the 4 fixed tabs — reachable via the "More" sheet instead of only the Cmd+K search, which was the only way in on mobile before this. */
const MORE_ITEMS = [
